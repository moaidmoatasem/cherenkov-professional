...
agents = [
    ...
    MicroAgent(
        MicroAgentConfig(
            role="GuideCreator", purpose="Create usage guide", tool_function=create_usage_guide
        )
    ),
    MicroAgent(
        MicroAgentConfig(
            role="READMEUpdater", purpose="Update main README", tool_function=update_main_readme
        )
    ),
]
