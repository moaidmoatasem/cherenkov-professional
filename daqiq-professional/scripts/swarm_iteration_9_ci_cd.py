...
"""
    ...
    return {"file": str(test_workflow), "trigger": "push, pull_request", "runs_on": "ubuntu-latest"}
...
"""
    ...
    return {"file": str(docker_workflow), "trigger": "push to main, tags", "builds": "Docker image"}
...
agents = [
    ...
    MicroAgent(
        MicroAgentConfig(
            role="BadgeAdder", purpose="Add CI badges to README", tool_function=create_badges_readme
        )
    ),
]
