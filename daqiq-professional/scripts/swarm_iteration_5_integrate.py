...
""")
    ...
    return {"examples_created": 2, "files": [str(simple_workflow), str(parallel_workflow)]}
...
'''
    ...
    return {"file": str(parser_file), "classes": ["WorkflowParser"], "functions": ["load_workflow"]}
...
'''
    ...
    return {"file": str(test_file), "tests": 3, "coverage": "workflow_parser + orchestration_api"}
