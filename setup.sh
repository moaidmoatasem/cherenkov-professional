#!/bin/bash
# DAQIQ NEXUS - Quick Setup Script

echo "🚀 DAQIQ NEXUS - AI Security Orchestrator Setup"
echo "================================================================"
echo ""
...
# Start all services
echo "🐳 Starting all DAQIQ NEXUS services..."
docker-compose up -d
...
docker exec daqiq-ollama ollama pull deepseek-r1:1.5b
