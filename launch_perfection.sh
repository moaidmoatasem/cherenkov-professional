...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  🚀 DAQIQ PERFECTION LAUNCH SEQUENCE                        ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
...
status "Starting DAQIQ scanner..."
docker-compose -f docker-compose.optimized.yml up -d daqiq
...
echo "  • Run scan: docker exec daqiq-scanner python daqiq_simple_scanner.py https://example.com"
